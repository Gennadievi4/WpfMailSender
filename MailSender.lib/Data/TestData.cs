...
namespace MailSender.lib.Data
{
    public static class TestData
    {
        ...
        {
            new Server {ID=1, Name = "Яндекс", Adress = "smtp.yandex.ru", LogIn = "login yandex", Password = "passwordYandex".Encode(3), Port = 587},
            new Server {ID=2, Name = "Гугл", Adress = "smtp.gmail.com", LogIn = "login gmail", Password = "passwordGmail".Encode(3), Port = 25},
            new Server {ID=3, Name = "Mail.ru", Adress = "smtp.mail.ru", LogIn = "login mail", Password = "passwordMail".Encode(3), Port = 587}
        };
